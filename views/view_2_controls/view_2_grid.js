...
export async function renderFacilityControls(data) {
    ...
    // Save current facility in localStorage as JSON string for fallback
    ...
    app.innerHTML = `
        ...
        <div class="controls-container">
            ...
            <div class="footer-tag">
                File: views/view_2_controls/view_2_grid.js | Updated: 2026-06-12 @ 12:50 PM
            </div>
        </div>
    `;
    ...
    requestAnimationFrame(() => {
        ...
        if (addressLink) addressLink.onclick = () => true;
    ...
    document.getElementById('toProjects').onclick = () => {
        if(window.navigateTo) window.navigateTo('view_4_projects', { currentFacility: facility });
    };
