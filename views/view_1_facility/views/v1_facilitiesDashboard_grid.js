/* =================================================
FILE: views/v1_facilitiesDashboard_grid.js
...
================================================= */
import { fetchFacilities } from './v1_facilitiesDashboard_data.js';
import { setupFacilitiesEvents } from './v1_facilitiesDashboard_events.js';
...
export async function renderFacilities() {
    ...
    app.innerHTML = `
        ...
        <div class="dash-container">
            ...
            <div style="margin-top: 50px; font-size: 0.8em; color: #666; border-top: 1px solid #ccc; padding-top: 10px;">
                File: v1_facilitiesDashboard_grid.js | Updated: 2026-06-02 05:20:00 PM
            </div>
        </div>
    `;
    ...
    if (data) {
        data.forEach(f => {
            ...
            // Updated file path navigation to reference the new structural grid file
            btn.onclick = () => window.navigateTo('v2_facilityControls_grid', f);
