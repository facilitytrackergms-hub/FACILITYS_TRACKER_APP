...
================================================= */
import { fetchContacts, deleteContact } from './view_3_data.js?v=2026_v6';
import { setupContactsEvents, openEditContactModal } from './view_3_modal.js?v=2026_v6';
...
export async function renderFacilityContacts(data) {
    ...
    const styles = `
        <style>
            ...
            .contact-thumbnail { background:white; border:1px solid #e5e7eb; padding:16px 12px; border-radius:8px; cursor:pointer; text-align:center; transition:transform 0.15s ease; display:flex; flex-direction:column; align-items:center; justify-content:center; position:relative; min-height:80px; }
            .contact-thumbnail:hover { transform:translateY(-2px); box-shadow: 0 2px 5px rgba(0,0,0,0.05); }
            .thumbnail-name { font-weight:bold; color:#00264d; font-size:14px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; width:100%; margin-top:0px; }
            .thumbnail-role { font-size:12px; color:#6b7280; margin-top:4px; }
        ...
        <div class="contacts-view-container" id="mainContactsContainer">
            <div class="contacts-card-wrapper">
                ...
                <div class="view-build-stamp">
                    File: views/view_3_contacts/view_3_grid.js<br>Updated: 2026-06-03 03:52:00 PM
                </div>
